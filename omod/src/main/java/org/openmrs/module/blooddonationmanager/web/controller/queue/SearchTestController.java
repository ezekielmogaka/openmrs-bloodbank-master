...
import org.openmrs.module.blooddonationmanager.web.controller.util.QueuePatient;
...
@RequestMapping("/module/blooddonationmanager/searchTest.form")
...
//			model.addAttribute("testNo", tests.size());
		...
		return "/module/blooddonationmodule/queue/search";
	}
