...
//import org.openmrs.module.blooddonationmanager.BloodDonationManager;
import org.openmrs.module.blooddonationmanager.api.BloodDonationManagerService;
...
//import org.openmrs.module.blooddonation.model.PreparedDonorId;

@Controller
@RequestMapping("/module/blooddonationmanager/newIds.form")
public class GenerateDonorIdController {
	...
	public String initForm(ModelMap map, @RequestParam(value="numberofids", required=false) String ids){
		...
		return "module/BloodDonation/newIdsForm";
	}
