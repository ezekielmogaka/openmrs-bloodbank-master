...
@RequestMapping("/module/blooddonationmanager/getHTMLObs.form")
public class GetHTMLObsController {
	...
	public String getHTMLObs(@RequestParam("name") String name,
		...
		Concept concept = BloodDonationManagerUtil.searchConcept(name);
		if (concept != null) {
		...
		return "/module/blooddonationmanager/editor/getHTMLObs";
	}
