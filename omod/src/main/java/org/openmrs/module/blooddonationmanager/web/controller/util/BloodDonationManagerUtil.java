package org.openmrs.module.blooddonationmanager.web.controller.util;
...
public class BloodDonationManagerUtil
{
	...
	public static void generateDataFromEncounter(Model model,
			Encounter encounter, BlooddonationManagerForm form) {
		if (encounter != null) {
