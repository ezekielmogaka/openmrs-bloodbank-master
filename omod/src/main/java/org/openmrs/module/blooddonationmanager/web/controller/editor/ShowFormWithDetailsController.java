...
@RequestMapping("/module/bloodddonationmanager/showFormWithDetails.form")
public class ShowFormWithDetailsController {
	...
	public String showFormWithDetails(
		...
		List<PersonAttribute>  personattris = new ArrayList<PersonAttribute>();
		List<PatientIdentifier>  personidfier = new ArrayList<PatientIdentifier>();
...
//		pdets.put("Address for Communication", patient.getPersonAddress().getAddress1());
		...
		return "/module/blooddonationmanager/editor/showDets";
	}
	...
	public String saveEncounter(HttpServletRequest request,
		...
		if (encounter != null) {
			...
			return "/module/blooddonationmanager/editor/enterForm";
		}
