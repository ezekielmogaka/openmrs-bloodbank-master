...
<script type="text/javascript" src="${pageContext.request.contextPath}/moduleResources/blooddonationmanager/scripts/jquery/jquery.form.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/moduleResources/blooddonationmanager/scripts/jquery/jquery.validate.pack.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/moduleResources/blooddonationmanager/scripts/jquery/jquery.validate.min.js"></script>
<script type="text/javascript">
	...
	// Submit the form
	function submitForm(){
		var rURL = getContextPath() + "/module/blooddonationmanager/showForm.form";
		validated = isValidated();
		//jQuery("#contentForm").valid();
		if(validated){
			var formContent = jQuery("#contentForm").formSerialize();
			jQuery.post(getContextPath() + "/module/blooddonationmanager/showForm.form", formContent, function(data) {
				${param.script}
			});
			 tb_remove();
		}
