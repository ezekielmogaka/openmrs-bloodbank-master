...
<table cellspacing="0" cellpadding="2" id="donorData">
	<thead><tr>
		...
		<th class="blooddonationmanagerID">Donation#</th>
	...
	<tr class="<c:choose><c:when test="${count % 2 == 0}">evenRow</c:when><c:otherwise>oddRow</c:otherwise></c:choose>">
		<td style="display:none">${enc.blooddonationmanagerId}</td>
		<td class="encounterDonorId">${enc.blooddonationmanagerId}</td>
		<td class="encounterType">${enc.questionnaire.encounterType.name}</td>
		<td class="encounterEdit" align="center">
			<openmrs:hasPrivilege privilege="Edit Encounters">
				<!--
				<a href="${pageContext.request.contextPath}/module/blooddonationmanagerManager/showForm.form?id=2&encounterId=${enc.questionnaire.encounterId}&mode=EDIT&returnUrl=${pageContext.request.contextPath}/module/blooddonationmanagerManager/showDonorEncounters.form">
				-->
		...
		<td class="encounterEdit" align="center">
			<c:if test="${ enc.test != null }">
				<openmrs:hasPrivilege privilege="Edit Encounters">
					<!--
					<a href="${pageContext.request.contextPath}/module/blooddonationmanagerManager/showForm.form?encounterId=${enc.test.encounterId}&mode=VIEW&returnUrl=${pageContext.request.contextPath}/module/blooddonationmanagerManager/showDonorEncounters.form">
					-->
		...
		<c:choose>
			<c:when test="${ enc.bloodResult != null }">
				<td class="encounterEdit" align="center">
					<openmrs:hasPrivilege privilege="Edit Encounters">
					<!--
                <a href="${pageContext.request.contextPath}/module/blooddonationmanagerManager/showForm.form?encounterId=${enc.bloodResult.encounterId}&mode=VIEW&returnUrl=${pageContext.request.contextPath}/module/blooddonationmanagerManager/showDonorEncounters.form">
                -->
