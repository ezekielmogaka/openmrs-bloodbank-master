...
<script type="text/javascript" src="${pageContext.request.contextPath}/moduleResources/blooddonationmodule/scripts/CKEditor/ckeditor.js"></script>
...
<script type="text/javascript" charset="utf-8">
	...
	*/
	...
	function insertObs(name, type, required){		
		jQuery.ajax({
			type : "GET",
			url : getContextPath() + "/module/blooddonationmanager/getHTMLObs.form",
			data : ({
				name			: name,
				type			: type,
				required		: required
