...
<script type="text/javascript">	
	...
	jQuery(document).ready(function(){		
		jQuery("#conceptPopup").autocomplete(getContextPath() + '/module/blooddonationmanager/ajax/autocompleteConceptSearch.htm').result(function(event, item){window.parent.insertObs(jQuery('#conceptPopup').val(),'${type}',getConceptRequired()); tb_remove();});
